...
まずは、ページ数をある程度価格の指標とすることができます。これは、他のサークルと同程度の価格をつける、という意味で参考にすることができます。印刷所に発注しオフセットまたはオンデマンドで製本したもので、目安は10ページあたり100円から200円が標準的な値段付けとなるでしょう。30ページから50ページなら500円程度、60ページ以上は1000円つけても、ほかと比べて高いとか安いという印象は持たれないと思われます。コピー本(ホチキス止めのプリンタ本など)については、現実的な厚さのコピー本(～20P程度)で、200円とか300円とかが一般的でしょうか。
