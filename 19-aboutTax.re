...
記入は、売上と必要経費を記入します。詳細記載した別紙を添付しても良いでしょう。確定申告書に記載する、収入と必要経費、所得の根拠資料となります。これを作った上で、利益が20万を下回っている場合は、そもそも記載する必要がなくなります。この帳簿が、税務調査等においての証拠となります。「売上はあったけれど、利益は出ていませんから、同人活動による納税義務は生じません」という主張の根拠になります。なお、税務調査の対象になる確率はおよそ1%と言われています。このときに慌てることなく対応資料としても利用できます。またそもそも利益が出ているのかどうか、次の印刷部数および価格設定の参考にもなりますから、頒布実績の整理と、経費の整理はぜひやっておくべきです。
