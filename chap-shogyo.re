...
== 同人誌を商業化するということ
技術書典や技書博など、技術同人誌を扱うイベントはたくさんあり、多数の技術同人誌が日々発行されてます。そしてそれら技術同人誌を底本にして、プロの（出版社の）編集・校正を加えて発行する形態の商業誌が多数発行されています。良くも悪くも（数の上でも）目立つのがインプレスR&D Next Publishtngの@<strong>{技術の泉シリーズ}@<fn>{izumi}です。他の出版社では特定のシリーズ名はついてないようです。見落としてる可能性もありますが。
...
とはいえ、まだ技術書典を知らない人も少なくありません。技術書典のユニークIDは2万くらいだそうです。日本国内のITエンジニア100万人、それ以外のエンジニア含めても200万人（←200万という数字にあまり根拠はありませんが）と考えて、技術同人誌という世界は、エンジニアの1％くらいしか知らない世界です。そんな中、Amazon で検索に引っかかれば買ってみる人も増えるでしょう。
...
なお、技術同人誌の商業化の文脈で、「すでに何千部頒布しているので十分」というコメントを見かけることはありますが、その場合とは話を分けて考えた方がいいかもしれません。
...
そこそこ数の出る技術同人誌ならオフセット印刷でやる場合が多いですが、注文の都度印刷される形態の商業版（POD)では、オンデマンド印刷になり、印刷クオリティが下がります。オンデマンド印刷、要するに大きなレーザープリンターですから、残念ながらオフセット印刷よりしょぼくなります。
...
=== 手取り・印税率が下がる
これは残念ながら本当でした。頒布数に対して実質の入金額は少ないですね。なんか計算おかしくね？と担当の編集者に確認してしまいました。「定価×印税率」だと思ってたんですが、「出版社入金額×印税率」でした。それにしても、「マジか、印税少ねぇ・・・」が偽らざる感想でした。

後述の通り、底本に加筆する形で商業化しているので、商業化にあたっての工数はめちゃめちゃかかったわけではありません。しかし、山ほど書き直ししてこの印税だとも確かに微妙な気持ちになるかもしれません。

技術同人誌を書こうの場合、17年末（冬コミ）に発行し、その後18年4月の技術書典に商業化しましたので、実質4か月でした。このうちで、全体の校正と、2章ほど書き足しました。見積もり本の場合も、1章まるまる追記、全体の加筆修正、文章校正などです。デッドライナーにとってやはり締め切りは重要で、加筆および修正は締め切り前の一ヵ月くらいが山です

とはいえ、底本が前提でそこに追記するという企画ですから、かかった工数という意味では納得できると考えています。著者が書きたいと思っている内容を書き切っていれば、ほとんど追記や修正なく、（文章校正のみで）出版に行くことも少なくないそうですね。
...
なお、技術の泉シリーズは、PODのため、差し替え改訂は可能です。BOOTH差し替えほど簡単ではありませんが、そもそも初動初版とかありませんから、在庫捌けるまで待ってくれといった制約はありません。
...
という形で発行しています。方針変更がありませんし、書き直し部分はほとんどないので、自分の書きたい作りたい企画ではないという意識は皆無でした。むしろ、何が足りないのかが明確になるので、そこを追記することで内容の厚み、カバー範囲が増えるメリットが大きかったと思います。てにをは修正を依頼されたとして、自由度が阻害されたとは感じないですよね？
...
超ざっくり話で、同人版で500部、さらに商業化して500部販売したと考えれば、商業化したことで２倍の人に届いたということになります。
...
あれ？デメリットの方が多くない？と思ったあなた、それは直観としては正しいと思います。販路拡大するかもしれないけど、印税率下がるし、自由度下がるし。商業出版に関するネガティブな言説はそこかしこで見かけます。
...
ただ、だからといって、商業出版が必ず正義であるというつもりはありません。上記のデメリットはいずれも程度の問題ではあれ、事実でしょう。デメリットをコントロールしつつ、メリットを享受するために、企画や契約内容をあらかじめ確認することは重要です。
