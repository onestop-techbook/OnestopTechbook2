...
なお書類不備、つまり必要事項の記入がなされていない場合は問答無用で落選となる場合が多いようです。くれぐれも必須記入欄が空欄のまま、といったミスは避けましょう。Web申込ならば、空欄に対してエラー表示がされることがあります。特に、申込期限ぎりぎりに入力しようとすると、足りないデータがあって焦る、といったことも起こりかねません。
