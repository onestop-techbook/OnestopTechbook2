...
//embed{
    ...
    \hspace{1ex}
//}
合同誌を企画・編集したり、サークル主だったり、「技術同人誌はいいぞ」と話したり。妖怪「本書いてけ」として著者の背中を押す/沼に引きずり込む役も。

== 執筆者
始めにおわび；執筆者の皆さんのコメントは、2018年(技術同人誌を書こう初版)または2019年(合同誌を作ろう初版)時のコメントです。2023年11月現在の状況とは変わっている可能性があります。すべて、おやかたの責任です。申し訳ありません。最新情報はTwitter(X)等でご確認ください。
...
//embed{
    ...
    \hspace{1ex}
//}
僕も重度の締め切り駆動執筆罹患者なんですが、技術書典4は余裕のあるスケジュールで書きたいなーなどと思っています。先端エッジのソフトウェア技術からエモい話、なんでもござれ。JavaScript/TypeScript大好きのわりにはフロントエンドはあまりやってなくてバックエンドやインフラ技術の方が詳しいという謎の存在。技術書典4もきっとJSに絡めた何かを書いていると思います。
...
//embed{
    ...
    \hspace{1ex}
//}
「パンプキンシザーズ」という漫画、クソおもしろいのでぜひ買ってください。
...
//embed{
    ...
    \hspace{1ex}
//}
フリーの駆け出しWEBエンジニア。お笑いライブの検索サイト「ワラリー！」を運営中。ITコンサル会社で業務システム設計・開発を担当していましたが、WEB系のプログラミング言語を独学してフリーランスになりました。合同誌「個人開発がやりたくなる本」（技術書典6発行）にも参加しています。技術ブログでは初心者向けの情報を発信中。

　
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
        \includegraphics[width=.75\linewidth]{images/contributors/hayashih.png}
    \end{minipage}
    \begin{minipage}{.89\linewidth}
        hayashih @hayashih https://twitter.com/hayashih\\
        サークル名：アナトリーラボ 
        \end{minipage}
    \hspace{1ex} 
//}
受託開発の会社で働くエンジニア。C#やASP.NETなどMS系技術を使うことが多いが、最近のMSの激変ぶりによりなんでも屋になりつつある。技術についての話を気軽にできる場が増えればいいなあ、と思いながら日々活動しています。

　
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
        \includegraphics[width=.75\linewidth]{images/contributors/zukkey_400x400.jpg}
    \end{minipage}
    \begin{minipage}{.89\linewidth}
        zukkey @zukkey59 https://twitter.com/zukkey59\\
        サークル名：エウレカ9
        \end{minipage}
    \hspace{1ex}
//}
