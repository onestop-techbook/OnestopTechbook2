...
この本の執筆は、Github+Re:VIEWの多人数同時執筆という形で実施しました。Twitterに最初の投げかけをしたのが10月末、その後えるきちさんと別イベントで会ったときに意気投合し、Gitとテンプレートの初期設定をやっていただいたのが11月1日で、それからの活動状況をグラフにしたものを貼ります。期間の調整のしかたがよくわからなかったので、そのままスクリーンショット貼り付けです。期間外については、もともとのTechboosterのほうの活動が反映されてるということでしょうか…
...
大きなイベントであれば、専用ページに各種締め切り一覧が記載されているはずです。そのページの中で、一番早い締切を締め切りに設定します。早い締切とは、早割の締切です。この早割締め切りに向けて、締め切り直前に全力を出すのです。間違っても、通常入稿締め切りや、割増締め切りを見てはいけません。

締め切り前の1週間のモチベーションが高いことは先に述べました。であるなら、締め切り直前が重要であり、締め切りは伸ばしたほうがよいではないか、という指摘もあろうかと思います。ここで、再度さっきのモチベーションカーブを見てみましょう。モチベーションが上がってくるのは締め切りの直前ですが、締切を1週間後ろにずらしてみましょう。その時のモチベーションカーブはどうなりますか？その場にとどまりますか？いいえ、締切に連動して、後ろに伸びます。ということは、モチベーションゼロの期間が1週間伸びるだけなのです。断言します。締め切りを1週間伸ばして鬼入稿しても、ページ数は増えないし、クオリティは上がりません。
...
もう一つのメリットは、進捗のバッファになる点です。コミケで言えば、冬コミ締め切り直前にインフルエンザに罹りました、夏コミ入稿前に夏風邪ひきましたなどありえます。この時鬼入稿締め切りをターゲットにしていると、本当に詰みます。早割締め切りから通常締め切り、鬼入稿締め切りまで1週間程度あるので、通常料金、最悪割増料金で対応できます。不測の事態の代償がお金で解決できるので問題ありません。
